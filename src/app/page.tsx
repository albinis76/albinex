...
export default function Home() {
   ...
   return (
      <div className="flex min-h-[100dvh] md:min-h-screen bg-brand-dark overflow-x-hidden font-sans">
         <div className="noise-bg"></div>
         <Sidebar />

         <main className="main-safe w-full md:w-[calc(100%-280px)] md:ml-[280px] relative z-10 overflow-x-hidden">
            {/* 1. HERO */}
            <section id="home" className="hero-section px-6 md:pl-0 md:pr-6 md:py-6 min-h-[100dvh] md:h-[100dvh] md:overflow-hidden flex items-center md:items-stretch pt-28 md:pt-6">
               <div className="grid lg:grid-cols-12 lg:grid-rows-[1fr_auto] gap-4 md:gap-6 w-full h-full">
                  ...
                  >
                     <div className="relative z-10 flex flex-col items-center text-center">
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-[0.9] tracking-tighter mb-6 md:mb-8">
                           Sua sacada está segura? <br />
                           <span className="text-brand-accent">Evite riscos</span> reais
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 w-full md:w-auto">
                           <a href="#contato" className="btn-primary group w-full sm:w-auto text-sm md:text-base py-4 md:py-5">
                              Solicitar Orçamento <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
                           </a>
                           <a href={`https://wa.me/${whatsappNumber}`} target="_blank" className="btn-outline group hover:border-brand-accent/50 border-white/10 w-full sm:w-auto text-sm md:text-base py-4 md:py-5">
                  ...
                  >
                     <Image src="/images/hero-bg.png" alt="Manutenção de Sacadas" fill className="object-cover transition-transform duration-[1.5s] ease-out group-hover:scale-110 z-0" priority />
                     ...
                     <div className="flex -space-x-3">
                        {[1, 2, 3].map(i => (
                           <div key={i} className="w-9 h-9 rounded-full border-2 border-brand-dark overflow-hidden bg-zinc-800">
                              <Image src={`https://i.pravatar.cc/150?u=${i}`} alt="user" width={36} height={36} />
                           </div>
                        ))}
                     </div>
               ...
               <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                  <motion.div {...slideUp}>
                     ...
                     <h2 className="text-4xl md:text-7xl font-black text-white leading-none tracking-tighter">
                        Engenharia de <br /> <span className="text-zinc-700">Alta Performance</span>
                     </h2>
                  </motion.div>
               ...
               <div className="grid md:grid-cols-3 gap-8">
                  {[
                     ...
                     >
                        ...
                        <a href={`https://wa.me/5511993803195`} target="_blank" className="flex items-center gap-2 text-white font-black text-sm uppercase tracking-widest group-hover:gap-4 transition-all">
                  ...
                  <div className="grid lg:grid-cols-2 gap-20 items-center">
                     <motion.div {...slideUp}>
                        <h2 className="text-4xl md:text-6xl font-black text-white mb-10 tracking-tighter leading-none">
                           Por que somos a <br /> <span className="text-brand-accent">referência técnica?</span>
                        </h2>
                     ...
                     <motion.div {...slideUp} className="relative mt-12 md:mt-0">
                        <div className="aspect-square rounded-[3rem] overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 shadow-2xl group">
                           <Image src="/images/gallery/5.jpeg" alt="Técnico RA" fill className="object-cover transition-transform duration-700 group-hover:scale-110" />
                        </div>
            ...
            <section id="galeria" className="px-6 md:pl-0 md:pr-6 py-16 md:py-24 w-full">
               <div className="text-center mb-16">
                  <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter mb-6">Serviços Realizados</h2>
               ...
               <div className="bg-white rounded-[3rem] md:rounded-[4rem] p-8 md:p-24 text-black flex flex-col md:flex-row gap-12 md:gap-20 items-center shadow-2xl w-full">
                  <div className="md:w-1/2">
                     <h2 className="text-3xl md:text-7xl font-black leading-[1.1] tracking-tighter mb-8 md:mb-10">
                        Antecipamos problemas <br /> <span className="text-brand-accent">antes dos prejuízos</span>
                     </h2>
                     ...
                     <div className="space-y-6">
                        <a href={`https://wa.me/5511993803195`} target="_blank" className="flex items-center gap-4 text-lg md:text-2xl font-black hover:text-brand-accent transition-colors">
                        ...
                        <div className="flex items-center gap-3 md:gap-4 text-sm sm:text-lg md:text-xl font-bold opacity-60">
                           ...
                           <span className="break-all">contato@ramanuntencao.com.br</span>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="w-full md:w-1/2 bg-zinc-100 p-6 md:p-16 rounded-[3rem] md:rounded-[3.5rem]">
                     <form onSubmit={handleSendForm} className="space-y-6">
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400">WhatsApp (DDD + Número)</label>
                           <input
                              type="tel"
                        ...
                        <div className="space-y-2">
                           <label className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Descrição do Problema</label>
                           <textarea
                        ...
                        <button type="submit" className="w-full bg-brand-dark text-white font-black py-6 rounded-2xl shadow-2xl hover:bg-black transition-all duration-300 hover:scale-[1.02] active:scale-95 text-lg uppercase tracking-widest">
                           Enviar Solicitação
                        </button>
                     </form>
                  </div>
            ...
            <footer className="py-20 text-center border-t border-brand-border">
               ...
               <p className="text-zinc-500 font-medium">Desenvolvido por ALBINEX</p>
               <p className="text-zinc-500 font-medium">carlosribeiro@vk.com</p>
            </footer>
         </main>
