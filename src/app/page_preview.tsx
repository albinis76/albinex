               ...
               <div className="bg-white rounded-[3rem] md:rounded-[4rem] p-8 md:p-24 text-black flex flex-col md:flex-row gap-12 md:gap-20 items-center shadow-2xl w-full">
                  <div className="md:w-1/2">
                     ...
                     <div className="space-y-6">
                        <a href={`https://wa.me/5511993803195`} target="_blank" className="flex items-center gap-4 text-lg md:text-2xl font-medium hover:text-brand-accent transition-colors">
                        ...
                        <a href="mailto:contato@ramanutencaodesacadas.com.br" className="flex items-center gap-3 md:gap-4 text-sm sm:text-lg md:text-xl font-medium hover:text-brand-accent transition-colors">
